...
<main class="w-screen overflow-hidden relative">
    ...
    <section id="home" class="w-full max-w-lg text-center h-screen relative grid place-items-center overflow-hidden mx-auto">
        ...
        <div class="absolute w-full h-1/2 left-0 top-0 bg-gradient-to-b from-amber-500/75 via-white/25 to-white/0 z-40"></div>
        <div class="absolute w-full h-[80vh] left-0 bottom-0 bg-gradient-to-t from-amber-600 via-white/25 to-white/0 z-40"></div>
    ...
    <section id="main" class="w-full max-w-lg text-center h-screen relative grid place-items-center overflow-hidden relative mx-auto">
        <div class=" h-full w-full">
            <div class="w-full h-[15vh] bg-gradient-to-b from-amber-600 via-white/0 to-white/0 absolute"></div>
            <div style="background-image: url('/img/cover/2.jpg')" class="w-full h-[45vh] bg-cover bg-no-repeat bg-bottom"></div>

            <div class="text-center pt-14 bg-gradient-to-b from-amber-500 to-amber-100 h-full rounded-t-full  absolute w-[125%] left-1/2 -translate-x-1/2 top-[30%] z-20">
    ...
    <section class="w-full max-w-lg bg-gradient-to-br from-amber-200 to-amber-700 px-10 py-5 mx-auto">
    ...
    <section class="w-full max-w-lg min-h-screen bg-gradient-to-r from-amber-100 to-amber-400 px-4 pb-20 pt-10 mx-auto">
            ...
            <div class="h-full w-full bg-amber-50 rounded-full text-center flex flex-col justify-center py-10">
                ...
                <div>
                    ...
                    <div class="text-center mt-3">
                        <h2 class="great-vibes-regular text-amber-800 text-3xl">Dea Fitriani Sabila</h2>
                        <div class="mt-1 text-sm font-medium">
    ...
    <section class="w-full max-w-lg bg-gradient-to-l from-amber-50 to-amber-200 px-2 pb-20 pt-10 mx-auto">
            ...
            <div class="h-full w-full bg-amber-400 rounded-xl overflow-hidden pb-10 relative max-w-sm mx-auto">
                <div style="background-image: url('/img/cover/3.jpg')" class="h-72 bg-cover bg-no-repeat bg-bottom w-full"></div>
                <div class="absolute left-0 top-48 h-24 w-full bg-gradient-to-t from-amber-400 via-amber-400/25 to-white/0 z-30"></div>
                ...
                <div class="px-5 pt-5 flex space-x-4">
                    <div class="text-center flex-1">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="" class="flex border w-fit pl-2.5 space-x-1 pr-3.5 py-1 rounded-xl items-center border-2 text-sm text-white bg-amber-600 hover:bg-amber-600 font-bold mt-2 mx-auto">
    ...
    <section class="w-full max-w-lg bg-gradient-to-r from-amber-50 to-amber-200 px-2 pb-20 pt-10 mx-auto">
            ...
            <div class="h-full w-full bg-amber-600 rounded-xl overflow-hidden px-4 py-5 relative">
    ...
    <section class="w-full max-w-lg bg-gradient-to-r from-amber-50 to-amber-200 px-2 pb-20 pt-10 mx-auto">
            ...
            <div class="my-3 flex items-center px-3">
                <div class="border-b border-amber-600 flex-1"></div>
                <p class="px-1 text-amber-600 font-bold">~</p>
                <div class="border-b border-amber-600 flex-1"></div>
                <p class="px-1 text-amber-600 font-bold">~</p>
                <div class="border-b border-amber-600 flex-1"></div>
            </div>
    ...
    <section class="w-full max-w-lg bg-gradient-to-br from-amber-200 to-amber-700 px-5 pt-8 pb-20 mx-auto">
...
<div id="progress-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-amber-100 rounded-lg shadow ">
            ...
            <div class="p-4 md:p-5">
                <div class="px-2 py-4 bg-amber-200 shadow rounded-md">
                    ...
                    <div class="w-full max-w-sm">
                        ...
                        <div class="relative w-full">
                            <input id="website-url" type="text" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-e-0 border-gray-300 text-gray-500 text-sm border-s-0 focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5  " value="3580553248" readonly disabled />
                        </div>
                        <button data-tooltip-target="tooltip-website-url" data-copy-to-clipboard-target="website-url" class="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-white bg-amber-700 rounded-e-lg hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 " type="button">
                ...
                <div class="flex items-center my-4">
                    <div class="flex-1 border-b border-amber-600"></div>
                    <div class="px-3 italic text-amber-600">or</div>
                    <div class="flex-1 border-b border-amber-600"></div>
                </div>
            ...
            <div class="px-2 py-4 bg-amber-200 shadow rounded-md">
                ...
                <div class="w-full max-w-sm">
                    ...
                    <div class="flex items-center">
                        <span class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg">Norek</span>
                        <div class="relative w-full">
                            <input id="website-url22" type="text" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-e-0 border-gray-300 text-gray-500 text-sm border-s-0 focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5  " value="0971084200" readonly disabled />
                        </div>
                        <button data-tooltip-target="tooltip-website-url22" data-copy-to-clipboard-target="website-url22" class="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-white bg-amber-700 rounded-e-lg hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 border border-amber-700 hover:border-amber-800" type="button">
                            <span id="default-icon">
                                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                    <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-5H5a1 1 0 0 1 0-2h2V2h4v2h2a1 1 0 1 1 0 2Z"/>
                                </svg>
            ...
            <div class="px-2 py-4 bg-amber-200 shadow rounded-md">
                ...
                <div class="w-full max-w-sm">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                            <input id="alamat-url22" type="text" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-e-0 border-gray-300 text-gray-500 text-sm border-s-0 focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5  " value="Jl Nasnajshaj jhdbajhsd asjhdbjahs " readonly disabled />
                        </div>
                        <button data-tooltip-target="tooltip-alamat-url22" data-copy-to-clipboard-target="alamat-url22" class="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-white bg-amber-700 rounded-e-lg hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 border border-amber-700 hover:border-amber-800" type="button">
                            <span id="default-icon">
                                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                    <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-5H5a1 1 0 0 1 0-2h2V2h4v2h2a1 1 0 1 1 0 2Z"/>
                                </svg>
                ...
                <div class="flex items-center justify-center mt-8 space-x-4 rtl:space-x-reverse">
                    <button data-modal-hide="progress-modal" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="text-white bg-amber-700 hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Konfirmasi Lewat WhatsApp</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="#">
                    <div>
                        <input type="text" name="nama" id="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5" placeholder="Nama Anda" />
                    </div>
                    <div>
                        <input type="text" name="nominal" id="nominal" placeholder="Nominal Transfer" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5" />
                    </div>
                    <div class="">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="via-1" name="via" type="radio" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-amber-300" required />
                            </div>
                            <label for="via-1" class="ms-2 text-sm font-medium text-gray-900">BCA</label>
                        </div>
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="via-2" name="via" type="radio" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-amber-300" required />
                            </div>
                            <label for="via-2" class="ms-2 text-sm font-medium text-gray-900">BRI</label>
                        </div>
                    </div>
                    <button type="submit" class="w-full text-white bg-amber-700 hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Konfirmasi Lewat WhatsApp</button>
                </form>
            </div>
        </div>
    </div>
...
<!-- BOOTOM NAVIGATION -->
<div class="fixed z-40 w-full h-16 max-w-lg -translate-x-1/2 bg-amber-600 border border-gray-100 rounded-full bottom-4 left-1/2">
